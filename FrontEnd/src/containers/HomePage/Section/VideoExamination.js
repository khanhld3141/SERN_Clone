...
class VideoExamination extends Component {
   constructor(props) {
      super(props);
      this.state = {
         arrSpecialty: [],
            ...
            <div className="specialty-content">
               <div className="header-title">
                  <span className="header-main-title">
                     <FormattedMessage id="home-page.video-examination" />
                  </span>
                  <span className="more">
               ...
               <Slider {...settings}>
                  {arrSpecialty &&
                     ...
                     arrSpecialty.map((specialty, index) => {
                        let linkDetail = `/detail-doctor/${specialty.id}`;
                        return (
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(VideoExamination));
